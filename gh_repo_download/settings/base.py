"""
Django settings for gh_repo_download project.
...
WSGI_APPLICATION = "gh_repo_download.wsgi.application"
...
STATICFILES_DIRS = [BASE_DIR / "downloader/vite_assets_dist/", BASE_DIR / "static"]
