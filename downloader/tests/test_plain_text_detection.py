...
def test_plain_text_file():
    ...
    assert is_plain_text_file(file_obj) == True
...
def test_binary_file():
    ...
    assert is_plain_text_file(file_obj) == False


def test_empty_file():
    file_obj = io.BytesIO(b'')
    assert is_plain_text_file(file_obj) == True  # Depending on interpretation; adjust based on your definition
